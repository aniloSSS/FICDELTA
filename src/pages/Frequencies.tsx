import FrequencyTrainer from '../components/FrequencyTrainer';
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-bold text-slate-950 dark:text-white sm:text-4xl">
              Airport Frequencies Training
            </h2>
          </div>
          <p className="max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-300 sm:text-base">
            Memorize the airport and aerodrome frequencies required for FIC DELTA.
          </p>
        </div>
      </section>

      <FrequencyTrainer items={frequencies} />
    </div>
  );
}
